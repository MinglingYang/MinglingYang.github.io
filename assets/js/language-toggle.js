(function () {
  ...
  var zh = {
    ...
    "Presentations": "会议报告",
    "Skills": "技能",
    "Open-source teaching template": "开源教学模板",
    "Build your own academic website": "搭建你自己的学术个人网站",
    "Reuse this bilingual GitHub Pages template with Google Scholar updates, an interactive research globe, SEO, and complete English and Chinese setup guides.": "复用这个双语 GitHub Pages 模板，获得 Google Scholar 自动更新、交互式研究地球、SEO，以及完整的中英文搭建教程。",
    "Explore the template": "了解模板",
    "Use this template": "使用此模板",
    "Mingling (Mona) Yang": "杨明灵 (Mona)",
    "Ph.D. Student in Epidemiology": "流行病学博士生",
    ...
    "As a Ph.D. student in Epidemiology at USC under the mentorship of Dr. Vaia Lida Chatzi, I am broadening my research in environmental health, with a focus on PFAS, exposomics, multi-omics, and life-course approaches to environmental epidemiology.": "作为 USC 流行病学博士生，我在 Vaia Lida Chatzi 博士指导下正在拓展环境健康研究，重点关注 PFAS、暴露组学、多组学以及生命历程环境流行病学方法。",
    ...
    "Investigating PFAS and multi-component exposures using exposomics approaches to inform environmental health risk assessment and policy.": "使用暴露组学方法研究 PFAS 与多组分暴露，为环境健康风险评估和政策提供证据。",
    ...
    "Examining the impacts of air pollution on respiratory outcomes across the life course using advanced epidemiologic and statistical methods.": "使用先进的流行病学与统计方法，研究空气污染对生命历程中呼吸健康结局的影响。",
    ...
    "Exploring environmental and social determinants that influence growth, development, and long-term health in vulnerable populations.": "探索影响脆弱人群生长、发育和长期健康的环境与社会决定因素。",
    ...
    "Developing reproducible workflows and applying modern data science techniques to generate robust, transparent, and actionable evidence.": "开发可复现工作流，并应用现代数据科学技术生成稳健、透明且可行动的证据。",
    "Programming": "编程",
    "Biostatistics": "生物统计",
    "Exposure & GIS": "暴露评估与 GIS",
    "Omics & Data": "组学与数据",
    "Tools": "工具",
    "Mixed Models": "混合模型",
    ...
    "M.S.E. in Applied Mathematics and Statistics, Whiting School of Engineering": "应用数学与统计硕士，怀廷工程学院",
    "B.S. in Statistics; minor in Risk Management and Insurance": "统计学学士，辅修风险管理与保险",
    "Fall 2026": "2026 年秋季",
    "2021 - 2023": "2021 年至 2023 年",
    "2017 - 2020": "2017 年至 2020 年",
    ...
    "Ph.D. student in Epidemiology.": "流行病学博士生。",
    "Environmental Health Track at the Keck School of Medicine, since Fall 2026.": "凯克医学院环境健康方向，2026 年秋季至今。",
    "Latin America": "拉丁美洲",
    "Asia": "亚洲",
    "Africa": "非洲",
    ...
    "Fall 2026: I began Ph.D. training in Epidemiology, Environmental Health Track, at the Keck School of Medicine of USC.": "2026 年秋季：我开始在南加州大学凯克医学院攻读环境健康方向流行病学博士。",
    "Fall 2026:": "2026 年秋季：",
    "Scholar citations:": "Scholar 引用：",
    "I began Ph.D. training in Epidemiology, Environmental Health Track, at the Keck School of Medicine of USC.": "我开始在南加州大学凯克医学院攻读环境健康方向流行病学博士。",
    ...
    "Senior Research Data Analyst - Medicine, Epidemiology and Biostatistics": "高级研究数据分析师 - 医学、流行病学与生物统计学",
    ...
    "Research Assistant - Department of Environmental Health and Engineering": "研究助理 - 环境健康与工程系",
    "Rollins School of Public Health, Emory University": "埃默里大学罗林斯公共卫生学院",
    "Data Analyst - Environmental Health & Epidemiology": "数据分析师 - 环境健康与流行病学",
    "Data Analyst, Prof. Kyle Steenland": "数据分析师，Kyle Steenland 教授",
    "Johns Hopkins University": "约翰斯·霍普金斯大学",
    "Teaching Assistant - Department of Applied Mathematics and Statistics": "助教 - 应用数学与统计系",
    "Qiangyuan Sporting Goods Co.": "强源体育用品公司",
    "Data Scientist - Zhuhai, China": "数据科学家 - 中国珠海",
    "Shandong University, Shandong Big Data Research Association": "山东大学，山东省大数据研究会",
    "Research Assistant - Statistics and Finance, Jinan, China": "研究助理 - 统计与金融，中国济南",
